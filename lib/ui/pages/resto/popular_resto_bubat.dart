...
class PopularRestoBuahBatuPage extends StatefulWidget {
  const PopularRestoBuahBatuPage({Key? key}) : super(key: key);

  @override
  State<PopularRestoBuahBatuPage> createState() =>
      _PopularRestoBuahBatuPageState();
}

class _PopularRestoBuahBatuPageState extends State<PopularRestoBuahBatuPage> {
  @override
  void initState() {
